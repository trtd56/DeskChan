...
let outputPath = "artifacts/demo_video/cards/00_hackathon_hero_en.png"
...
if let gradient = NSGradient(colors: [
    NSColor(calibratedWhite: 0.0, alpha: 0.80),
    NSColor(calibratedWhite: 0.0, alpha: 0.55),
    NSColor(calibratedWhite: 0.0, alpha: 0.13),
...
drawText(
    ...
    rect: NSRect(x: 88, y: 476, width: 720, height: 36),
    size: 24,
    weight: .medium,
...
drawText(
    "Desk-Side\nAI Commentator",
    rect: NSRect(x: 84, y: 306, width: 760, height: 160),
    size: 60,
    weight: .bold,
    color: .white,
    lineSpacing: 7
...
drawText(
    "Low-latency multimodal AI\nthat reacts to your desk in real time.",
    rect: NSRect(x: 90, y: 218, width: 720, height: 76),
    size: 29,
    weight: .semibold,
...
drawText(
    ...
    rect: NSRect(x: 90, y: 160, width: 560, height: 34),
    size: 22,
    weight: .regular,
